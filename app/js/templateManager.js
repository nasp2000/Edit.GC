const templateManager = {
  ...
  extractFromCommands(commands) {
    const lines = ['; TEMPLATE: extracted pattern',
      ...
      ';',
      '; Legend:',
      ';   X Y Z A B C  â†’ axis positions (add your values after the letter)',
      ';   I J          â†’ arc center offsets (for G2/G3)',
      ';   F            â†’ feed rate (kept from original)',
      ';   S            â†’ laser power / spindle speed (kept from original)',
      ';',

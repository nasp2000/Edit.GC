...
{ section: 'Machine Origin (XYZ + ABC)', options: [
          ...
          { id: 'machineY', label: 'Y', type: 'number', default: -1.05, unit: 'mm' },
          { id: 'orientB', label: 'B', type: 'number', default: -75, unit: 'deg' },
          { id: 'homeZ', label: 'Z', type: 'number', default: -96.19, unit: 'mm' },
          { id: 'orientC', label: 'C', type: 'number', default: 90, unit: 'deg' },
